...
L.Handler.PathDrag = L.Handler.extend( /** @lends  L.Path.Drag.prototype */ {
  ...
  _onDragStart: function(evt) {
	...
	this._clientStartPoint = L.point(originalEvt.clientX, originalEvt.clientY);
    this._matrix = [1, 0, 0, 1, 0, 0];
    L.DomEvent.stop(originalEvt);
  ...
  _replaceCoordGetters: function() {
    if (this._path.getLatLng) { // Circle, CircleMarker
      ...
      this._path.getLatLng = L.Util.bind(function() {
		if(this.dragging._matrix === null) this.dragging._matrix = [1, 0, 0, 1, 0, 0];
