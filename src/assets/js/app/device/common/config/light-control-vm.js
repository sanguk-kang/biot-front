define("device/common/config/light-control-vm", [], function(){
	...
	var lightControlTemplate = '<div class="group-control-dialog-control groupControl">' +
			'<div class="controllerList noarr">' +
				...
				'<div class="innerBox">' +
					'<div class="innerSet">' +
						...
						'<p class="bluetit" data-bind="invisible:light.invisible">' + I18N.prop("FACILITY_DEVICE_LIGHT_BRIGHTNESS") + ' (0 ~ 100 %)</p>' +
	...
	function controlPower(popup, control){
		...
		// console.log("control light power");
	...
	return {
		lightControlTemplate : lightControlTemplate,
		lightControlViewModel : lightControlViewModel
	};
});

//# sourceURL=device/common/config/light-control-vm.js
