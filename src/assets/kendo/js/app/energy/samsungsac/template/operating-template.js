/**
	*
	*   <ul>
	*       <li>operating에 관련된 template 설정 작업</li>
	*   </ul>
	*   @module app/energy/samsungsac/template/operating-template
	*   @param {Object} 없음
	*   @requires 없음
	*   @returns {Object} scheduleActivatedTemplate - template 생성 메소드 설정
	*/
define("energy/samsungsac/template/operating-template", [], function(){
	/*
...
//# sourceURL=energy/consumption/template/consumption-template.js